...
export const ERROR_MESSAGES: Record<string, string> = {
  ...
  PENDING_REVIEW:            'حسابك قيد المراجعة - يمكنك تصفح المزادات فقط',
  ...
  AUCTION_NOT_ACTIVE:        'المزاد غير نشط',
  AUCTION_STILL_ACTIVE:      'المزاد لا يزال نشطاً - يمكنك اختيار الفائز بعد انتهاء المزاد',
  AUCTION_EXPIRED:           'المزاد منتهي',
  CANNOT_BID_OWN:            'لا يمكنك المزايدة على مزادك',
  ...
  CANNOT_CANCEL_WITH_BIDS:   'لا يمكن إلغاء المزاد بعد وجود عروض',
  MAX_CANCELLATIONS:         'وصلت للحد الأقصى للإلغاء (3 شهرياً)',
  NOT_AUCTION_OWNER:         'أنت لست صاحب المزاد',
  ...
  'invalid auction id':                    'معرف المزاد غير صحيح',
