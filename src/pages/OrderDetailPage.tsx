        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-green-50 rounded-xl p-3 text-center border border-green-100">
              <p className="text-xs text-gray-500 font-bold mb-1">السعر النهائي</p>
              <p className="text-lg font-extrabold text-green-600">{order.final_price}</p>
            </div>
          </div>
          {order.unit_price && (
            <div className="flex items-center justify-between text-sm">
              <span className="text-gray-500 font-bold">السعر للوحدة</span>
              <span className="font-bold text-gray-700">{order.unit_price}</span>
            </div>
          )}
        </div>
